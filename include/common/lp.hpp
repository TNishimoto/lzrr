    ...
    namespace lzrr
    {
        ...
        public:
            ...
            std::pair<SINDEX, uint64_t> take()
            {
                ...
                int64_t nextLowerLCP = lowerNextIndex >= (int64_t)n ? -1 : (*lcpArr)[lowerNextIndex] < lowerLCP ? (*lcpArr)[lowerNextIndex]
                                                                                                                : lowerLCP;
                int64_t nextUpperLCP = upperNextIndex < 0 ? -1 : (*lcpArr)[upperNextIndex + 1] < upperLCP ? (*lcpArr)[upperNextIndex + 1]
                                                                                                          : upperLCP;
